...
def load_data(city, month, day):
    ...
    Args:
        ...
        (str) day - name of the day of week to filter by, or "all" to apply no day filter
    Returns:
        data_table - Pandas DataFrame containing city data filtered by month and day
    """
...
def display_raw_data(data_table):
    """
    Displays raw data sample of the filtered raw data.

    Args:
        data_table - Pandas DataFrame containing city data filtered by month and day
    returns:
        filtered raw data sample.
    """
